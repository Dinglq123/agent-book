...
<div align='center'>
    <img src="../imgs/4-figures/2-0.jpg" alt="alt text" width="90%">
...
<div align='center'>
    <img src="../imgs/4-figures/2-1.jpg" alt="alt text" width="60%">
    <p>图4.2 模型、数据并行</p>
</div>
...
<div align='center'>
    <img src="../imgs/4-figures/2-2.jpg" alt="alt text" width="30%">
    <p>图4.3 模型并行</p>
</div>
...
<div align='center'>
    <img src="../imgs/4-figures/2-3.png" alt="alt text" width="100%">
...
<div align='center'>
    <img src="../imgs/4-figures/2-4.jpg" alt="alt text" width="100%">
    <p>图4.5 PPO 训练流程</p>
</div>
