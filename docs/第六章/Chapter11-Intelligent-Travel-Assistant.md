# Chapter 11 Intelligent Travel Assistant
...
### 11.1.1 Why We Need an Intelligent Travel Assistant
...
### 11.1.2 Technical Architecture Overview

The system adopts the classic **front-end and back-end separation architecture**, divided into four layers, as shown in Figure 11.1:

<div align="center">
  <img src="imgs/13-figures/13-1.png" alt="" width="85%"/>
  <p>Figure 11.1 Intelligent Travel Assistant Technical Architecture</p>
</div>
...
### 11.1.3 Quick Experience: Run the Project in 5 Minutes
...
First, fill in the destination city, travel dates, preferences, budget, transportation and accommodation types in the homepage form. After clicking the "Start Planning" button, the system will display a loading progress bar and quickly generate a result page, as shown in Figure 11.2.

<div align="center">
  <img src="imgs/13-figures/13-2.png" alt="" width="85%"/>
  <p>Figure 11.2 Travel Assistant Planning Progress Page</p>
</div>

After successful loading, the page will clearly display itinerary overview, budget details, attraction map, daily itinerary details and weather information, as shown in Figures 11.3 and 11.4.

<div align="center">
  <img src="imgs/13-figures/13-3.png" alt="" width="85%"/>
  <p>Figure 11.3 Travel Assistant Planning Completion Page</p>
</div>

<div align="center">
  <img src="imgs/13-figures/13-4.png" alt="" width="85%"/>
  <p>Figure 11.4 Travel Assistant Planning Completion Page</p>
</div>

If users need personalized adjustments, they can click the "Edit Itinerary" button to freely adjust the order of attractions or delete certain attractions, as shown in Figure 11.5. After planning is complete, through the "Export Itinerary" dropdown menu, the final plan can be easily saved as an image or PDF file for convenient reference at any time.

<div align="center">
  <img src="imgs/13-figures/13-5.png" alt="" width="85%"/>
  <p>Figure 11.5 Travel Assistant Planning Completion Page</p>
</div>

## 11.2 Data Model Design

### 11.2.1 Data Flow in Web Applications
...
### 11.2.2 From Dictionaries to Pydantic Models
...
### 11.2.3 Core Concepts of Pydantic
...
### 11.2.5 Application of Data Models in Web Applications
...
## 11.3 Multi-Agent Collaboration Design

### 11.3.1 Why We Need Multi-Agent
...
### 11.3.2 Agent Role Design

Based on the task decomposition principle, we designed four specialized Agents, as shown in Figure 11.6:

<div align="center">
  <img src="imgs/13-figures/13-6.png" alt="" width="85%"/>
  <p>Figure 11.6 Multi-Agent Collaboration Flow</p>
</div>
...
### 11.3.3 Agent Collaboration Flow
...
This flow executes four steps sequentially, with the output of each step serving as input for the next step. Note that we use the `TripPlanRequest` and `TripPlan` Pydantic models defined in Section 11.2.

### 11.3.4 Query Construction
...
## 11.4 MCP Tool Integration Details

### 11.4.1 Why Not Call APIs Directly

In Section 11.3, we designed four Agents to collaborate on the travel planning task. Among them, AttractionSearchAgent, WeatherQueryAgent, and HotelAgent all need to call Amap's API to obtain data. A natural question is: why not call Amap's HTTP API directly in the Agent?
...
<div align="center">
  <img src="imgs/13-figures/13-7.png" alt="" width="85%"/>
  <p>Figure 11.7 amap-mcp-server Tools</p>
</div>

The Amap MCP server provides various tools, mainly divided into the following categories, as shown in Table 11.1:

<div align="center">
  <p>Table 11.1 Amap MCP Tool Categories</p>
  <img src="imgs/13-figures/13-table-1.png" alt="" width="85%"/>
</div>
...
As shown in Figure 11.8, suppose the user wants to search for attractions in Beijing. AttractionSearchAgent receives the query "Please search for historical and cultural attractions in Beijing". The Agent analyzes this query and decides to call the `amap_maps_text_search` tool with parameters `keywords=attraction, city=Beijing`.

<div align="center">
  <img src="imgs/13-figures/13-8.png" alt="" width="85%"/>
  <p>Figure 11.8 MCP Tool Call Flow</p>
</div>
...
### 11.4.4 Unsplash Image API Integration
...
## 11.5 Front-End Development Details

### 11.5.1 Front-End and Back-End Separation Web Architecture
...
The choice of front-end technology stack needs to consider several factors: development efficiency, performance, ecosystem, and learning curve. As shown in Table 11.2, the project chose the following technology stack:

<div align="center">
  <p>Table 11.2 Front-End Technology Stack</p>
  <img src="imgs/13-figures/13-table-2.png" alt="" width="85%"/>
</div>
...
In Section 11.2, we used Pydantic to define data models on the back-end, such as `Location`, `Attraction`, `DayPlan`, `TripPlan`, etc. On the front-end, we need to define corresponding TypeScript types.
...
### 11.5.3 API Service Encapsulation
...
## 11.6 Feature Implementation Details
...
### 11.6.1 Budget Calculation Feature
...
### 11.6.3 Itinerary Editing Feature
...
### 11.6.5 Side Navigation and Anchor Jumping
